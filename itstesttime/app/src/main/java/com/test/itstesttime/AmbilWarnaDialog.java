...
public class AmbilWarnaDialog {
	...
	public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
		...
		//fontSelector = view.findViewById(R.id.plain_text_input);
		{ // hide/show alpha
		...
		builder.setItems(new CharSequence[]{"Clear", "Ok", "Save", "Cancel"}, new DialogInterface.OnClickListener() {
			@Override
				...
				switch(which)
				{
					case 0:
						if(AmbilWarnaDialog.this.listener != null)
							AmbilWarnaDialog.this.listener.onClear();
						break;
					case 1:
						if(AmbilWarnaDialog.this.listener != null)
					...
					case 2:
						if(AmbilWarnaDialog.this.listener != null)
							AmbilWarnaDialog.this.listener.onSave();
						break;
					case 3:
						if(AmbilWarnaDialog.this.listener != null)
		...
		*/
		...
		// for the normal 3 button dialog
		...
		.setNeutralButton(R.string.screenshot_text, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				if (AmbilWarnaDialog.this.listener != null)
				{
		...
		.setItems(new CharSequence[]{"Clear"}, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				switch (which) {
					case 0:
